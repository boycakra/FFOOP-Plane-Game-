...
public class Starter4 extends JPanel 
{
	...
	static 
	{
		try 
		{
			player = ImageIO.read(new File(".\\Image\\player3.png"));
			...
			bullets = ImageIO.read(new File(".\\Image\\bullets.png"));
	...
	public static void main(String game4) {
		JFrame frame = new JFrame("GERILYA UDARA '47");
		Starter4 game = new Starter4();
		frame.add(game);
