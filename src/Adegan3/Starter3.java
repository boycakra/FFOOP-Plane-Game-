...
public class Starter3 extends JPanel 
{
	...
	static 
	{
		try 
		{
			...
			background = ImageIO.read(new File(".\\Image\\background2.png"));
	...
	public class MyMouseAdapter extends MouseAdapter 
	{
		...
		public void mouseMoved(MouseEvent e) {
			...
			if (e.getY() < 200 && !(state == GAMEOVER)){
				state = PAUSING;
			} else if (e.getY() > 200 && !(state == GAMEOVER)){
				state = RUNNING;
			}
		}
	...
	public static void main(String game3) {
		JFrame frame = new JFrame("GERILYA UDARA '47");
		Starter3 game = new Starter3();
		frame.add(game);
